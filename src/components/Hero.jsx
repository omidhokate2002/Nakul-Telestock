...
const Hero = () => {
  return (
    <div className="container text-center pt-16">
      ...
      <h2 className="text-7xl font-semibold italic text-cyan-600">
        YOUR PREMIER
      </h2>
      <h2 className="text-7xl font-bold mb-4 text-gray-800">
        REAL ESTATE MARKETPLACE
      </h2>
      <p className="text-gray-800 mb-4 pt-5">
        Where every search ends with a home
      </p>
      <div className="flex justify-center space-x-10 pt-5">
        <button className="bg-blue-500 text-white p-3 rounded-full hover:bg-blue-600 flex gap-2">
